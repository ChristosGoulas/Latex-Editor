...
public class LatexEditorView {
	...
	private String templateType = "Empty";
	private String name;
	private String path;
	...
	public void chooseSaveFile() {
		...
		Integer returnValue = jfc.showSaveDialog(null);
	...
	public void print() {
		this.myController.enact("PrintCommand");
	}
	...
	private void initialize() {
		...
		mnNewMenu_4.setIcon(newDocIcon);
		...
		mnNewMenu_5.setIcon(reportIcon);
		...
		mnBookTemplate.setIcon(bookIcon);
		...
		mnArticleTemplate.setIcon(articleIcon);
		/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
		/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
		...
		mnLetterTemplate.setIcon(letterIcon);
		
		/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
		/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
		
		mnNewMenu_3.add(mnNewMenu_1);
		mnNewMenu_1.setIcon(emptyIcon);
