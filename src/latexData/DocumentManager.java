		...
		if (mode == 1) {
			...
			String line = null;
			 try {
				 ...
				 BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream("/resources/tex/templates/"+fileName)));
			...
			String line = null;
			 try {
				 BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream("/resources/txt/"+fileName)));
				 while((line = bufferedReader.readLine()) != null) {
		                records += line + "\n";
		            } 
				 bufferedReader.close(); 
